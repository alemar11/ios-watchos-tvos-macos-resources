...
* [AlertToast](https://github.com/elai950/AlertToast) - Alert Toast is an open-source library in Github to use with SwiftUI. It allows you to present popups that don't need any user action to dismiss or to validate. `SwiftUI`
...
* [Red Zebra](https://github.com/JKKross/Red_Zebra) - Minimalist text/code editor for iOS.
...
* [Jukebox](https://github.com/Jaysce/Jukebox) - Jukebox is a macOS application that allows you to display and control the currently playing song from Spotify in the menu bar. `macOS` `SwiftUI`
...
* [OnlySwitch](https://github.com/jacklandrin/OnlySwitch) - OnlySwitch provides a series of toggle switches to simply your routine work.
* [Open source macOS apps](https://github.com/serhii-londar/open-source-mac-os-apps) - List of open source applications for macOS.
* [OpenSesame](https://github.com/OpenSesameManager/OpenSesame) - Native and encrypted password manager for iOS and macOS. `macOS` `SwiftUI`
...
* [DSFSparkline](https://github.com/dagronf/DSFSparkline) - A lightweight sparkline component, supporting Swift, SwiftUI, macCatalyst and Objective-C.
...
* [SimpleCollectionViewBooking](https://github.com/theodovgopol/SimpleCollectionViewBooking) - A simple booking feature using CollectionView and Compositional Layout. Available dates for booking come form a simple API.
...
* [WatchLayout](https://github.com/HocTran/WatchLayout)
...
* [DateScrollPicker](https://github.com/alberdev/DateScrollPicker) - Fully customizable date scroll view with picker feature for iOS written in Swift 5.
...
* [NikeClockIcon](https://github.com/mtynior/NikeClockIcon) - A clock inspired by Nike Watch Face that can be displayed in macOS Dock. `macOS`
...
* [HexadecimalKeyboard](https://github.com/PepperoniJoe/HexadecimalKeyboard) - A native iOS app creating a custom hexadecimal keyboard.
...
* [Dots](https://github.com/makomori/Dots) - Modern loading indicator for iOS 10.
...
* [KoalaActivityIndicator](https://github.com/Rajaikumar-iOSDev/KoalaActivityIndicator)
...
* [gmenu](https://github.com/amirdew/gmenu) - A redesigned menu for Gmail iOS app, implemented using SwiftUI.
...
* [HHDropDownList](https://github.com/Herbert77/HHDropDownList)
...
* [ChatLayout](https://github.com/ekazaev/ChatLayout) - ChatLayout is an alternative solution to MessageKit. It uses custom UICollectionViewLayout to provide you full control over the presentation as well as all the tools available in UICollectionView.
...
* [Metal](https://github.com/dehesa/Metal)
...
* [WhiteNavigationController](https://github.com/Zandor300/WhiteNavigationController) - A White UINavigationBar like in Apple's apps.
...
* [PartialSheet](http://github.com/AndreaMiotto/PartialSheet) - A custom SwiftUI modifier to present a Partial Modal Sheet. `SwiftUI`
...
* [DPPickerManager](https://github.com/priore/DPPickerManager) - UIPicker inside a UIAlertController.
...
* [PermissionsSwiftUI](https://github.com/jevonmao/PermissionsSwiftUI) - A SwiftUI package to handle permissions. `SwiftUI` 
...
* [JCGGProgressBar](https://github.com/jacquesCedric/JCGGProgressBar) - macOS custom progress bar UI component. `macOS`
...
* [PPAssetsActionController](https://github.com/pantuspavel/PPAssetsActionController) - Highly customizable Action Sheet Controller with Assets Preview written in Swift 3.
...
* [AdvertisingSlider](https://github.com/seroshtanov/AdvertisingSlider)
* [AlphaSlider](https://github.com/DavidBoyes/AlphaSlider) - A visual improvement of UISlider to be used to specify the alpha value of a color.
...
* [PUGradientSlider](https://github.com/PayalUmraliya/PUGradientSlider) - Custom UISlider with gradient color background.
...
* [RRRangeSliderSwiftUI](https://github.com/Rahul-Mayani/RRRangeSliderSwiftUI) - Custom range slider in SwiftUI. `SwiftUI`
...
* [SayWhat](https://github.com/marcdown/SayWhat) - Spotify artist search using speech recognition.
...
* [AutomaticStatusBarColor](https://github.com/dk53/AutomaticStatusBarColor) - A zero line component to manage status bar color automaticly throughout your application.
...
* [AMTabView](https://github.com/Abedalkareem/AMTabView) - AMTabView is a custom tab bar with amazing animation.
...
* [FredKitTabBarSplitView](https://github.com/frogg/FredKitTabBarSplitView) - A subclass of UITabBarController that translates UITabBarItems 1:1 into a Sidebar on iPadOS.
...
* [Parchment](https://github.com/rechsteiner/Parchment) - A paging view controller with a highly customizable menu. Built on UICollectionView, with support for custom layouts and infinite data source.
...
* [SelectPickerCell](https://github.com/oclef/SelectPickerCell) - UITableCell with UIPicker Dropdown.
* [Static](https://github.com/venmo/Static) - Simple static table views for iOS in Swift.
* [StretchyHeaderView](https://github.com/sunlubo/StretchyHeaderView) - A generic stretchy header for UIScrollView, and allows you to change navigation bar's appearance dynamically.
...
* [GodAnimation](https://github.com/daoinek/GodAnimation) - Simple animation for your views and cells.
...
* [https://github.com/younatics/YNExpandableCell](https://github.com/younatics/YNExpandableCell)
...
* [AnyFormatKit](https://github.com/luximetr/AnyFormatKit) - Text formatting framework written on Swift 5.0.
* [AppFolder](https://github.com/dreymonde/AppFolder) - AppFolder is a lightweight framework that lets you design a friendly, strongly-typed representation of a directories inside your app folder. All the system directories like "Caches/" and "Application Support/" are already present, and you can add yours using just a few lines of code.
...
* [FloatingPlayer](https://github.com/engmahsa/FloatingPlayer) - A Swift floating player like YouTube player, using AVPlayer.
...
* [VideoTimelineView](https://github.com/Tomohiro-Yamashita/VideoTimelineView) - Video timeline UI for iOS Apps.
...
* [DimensionsPickerView](https://github.com/hussc/DimensionsPickerView)
...
* [LocalConsole](https://github.com/duraidabdul/LocalConsole) - This Swift Package makes on-device debugging easy with a convenient PiP-style console that can display items in the same way print() will in Xcode.
* [LPThumbnailView](https://github.com/luispadron/LPThumbnailView) - A thumbnail view for iOS to give context to multiple images/videos using thumbnails and counter.
...
* [Preferences](https://github.com/sindresorhus/Preferences) - Add a preferences window to your macOS app in minutes. `macOS`
