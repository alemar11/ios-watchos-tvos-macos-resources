...
* [BSDropDown](https://github.com/bismasaeed00/BSDropDown) - It's to show dropdown menu list.
...
* [JNDropDownMenu](https://github.com/javalnanda/JNDropDownMenu)
...
* [LMSideBarController](https://github.com/lminhtm/LMSideBarController) - LMSideBarController is a simple side bar controller inspired by Tappy.
...
#### 🔹*Obj-C*
* [ATNavBarButton](https://github.com/apptality/ATNavBarButton) - A sub-class of UIBarButtonItem to insert custom buttons or indicatorView into your navigationBar with one line of code.
...
* [BMASpinningLabel](https://github.com/badoo/BMASpinningLabel) - BMASpinningLabel is an UI component which provides easy way for displaying and animating text inside it.
...
* [Parent-Child-ScrollView](https://github.com/SundeepSun/Parent-Child-ScrollView) - Child ScrollView contents changes based on the selection of Parent ScrollView selected item.
...
* [UIEmptyState](https://github.com/luispadron/UIEmptyState/tree/master/UIEmptyState) - An empty state control to give visually appealing context when building iOS applications.
...
* [UITextField_AutoSuggestion](https://github.com/chika-kasymov/UITextField_AutoSuggestion) - Category for UITextField to add auto suggestion feature.
...
* [GDPerformanceView](https://github.com/dani-gavrilov/GDPerformanceView) - Shows FPS, CPU usage, memory usage above the status bar.
...
* [iosMath](https://github.com/kostub/iosMath) - Beautiful math equation rendering on iOS.
...
#### 🔹*Obj-C*
* [AKVideoImageView](https://github.com/numen31337/AKVideoImageView) - UIImageView subclass which allows you to display a looped video and even dynamically switch it.
* [CustomVideoRecording](https://github.com/guowilling/CustomVideoRecording) - Custom video recording based on AVFoundation.
...
* [MELDynamicCropView](https://github.com/Leveton/MELDynamicCropView) - UIView subclass for cropping photos.
...
* [RevealingSplashView](https://github.com/PiXeL16/RevealingSplashView) - A Splash view that animates and reveals its content, inspired by Twitter splash.
* [SCAvatarBrowser](https://github.com/luosch/SCAvatarBrowser) - Provide detail view for thumb image.
...
* [WCSBubbleView](https://github.com/WrightsCS/WCSBubbleView) - 3-tier Bubble view with title, detail, value and some options.
